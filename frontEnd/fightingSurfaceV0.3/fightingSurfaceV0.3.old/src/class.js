class Human {
    ...
    /**
     * TODO: Methode pour attaquer un adversaire
     * * 1 - Tirer un nombre entre 0 et 100
     *          * si 95 100 attaque * 1.5
     *          * sinon si 0 5 attaque * 0.5
    ...
    /**
     * TODO: Methode qui vérifie le status actuel  mort - vivant
     * * 1 - Check la santé
...
class Enemy extends Human {
     ...
     * * 0.5 - Check si un ennemis n'est pas déjà instancier (Singleton) facultatif et difficile recherche
     ...
     * * 3 - Lancement d'une attaque || spécial
     */

    /**
     * TODO: Methode qui retire l'ennemie du DOM et le place en bas 
